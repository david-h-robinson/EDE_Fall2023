...
#Tidy up the code
ggplot(PeterPaul.chem.nutrients, aes(x=factor(PeterPaul.chem.nutrients$month,
...
surface_temp_1999_plot + 
  ...
  labs(color='Lake') + #This can be used to change the legend name
  theme_wsj()
```
...
#Alternatively for the filtering syntax
...
ggplot(EPAair, aes(
  ...
  geom_smooth(method="1m") #for some reason this line of best fit didn't work?
