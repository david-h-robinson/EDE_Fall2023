...
Nutrients_droppedNAs <- Nutrients %>%
...
#QUESTION -- Why does this result in multiple empty months?
...
#UPDATE -- need more than two plots per chart?
...
plot_grid(boxplot_temp + ylab(NULL) + theme(legend.position = 'none'),
          ...
          ncol = 1,  #QUESTION -- ncol versus nrow here -- see below
          align = 'vh', 
          labels = c('Temp', 'TP', 'TN'), 
          axis = 'b')
...
#QUESTION -- how to clean up x-axis?
