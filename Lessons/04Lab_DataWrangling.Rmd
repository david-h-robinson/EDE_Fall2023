...
summary(NTL.phys.data$lakename)
NTL.phys.data.TuesdayLake1990through1999 <-
  NTL.phys.data %>%
...
```{r Exercise 3 & 4}
#Example using pipes to wrangle data #Pipes really help with readability and see flow of calculations
...
#There's no month column
#Option 1 -- create a month column and pipe that in when filtering
#Option 2 -- when filtering, convert to month
