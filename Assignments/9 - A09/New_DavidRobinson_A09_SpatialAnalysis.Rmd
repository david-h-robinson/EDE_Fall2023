...
#QUESTION -- is this supposed to be NE or NC? If NE, how do we know which # to use?
...
#QUESTION -- pick one of these -- does it matter which one?

mapView(counties_sf_1)
...
> ANSWER: 
> ID["EPSG",4269]]
so this uses EPSG code 4269
The CRS uses angular and geographic.

> DATUM["North American Datum 1983",
    ELLIPSOID["GRS 1980",6378137,298.257222101,
        LENGTHUNIT["metre",1]]],
so this CRS is associated with "North American Datum 1983"
>
...
#QUESTION -- I think this is where you want to use the 'colClasses' bit of code
#QUESTION -- do I want to just use stringsAsfactors = TRUE?
...
#QUESTION -- this looks weird; check columns used when converting from csv to 
#spatial dataframe?
...
#QUESTION -- similar question as above here -- how to know which fields should be imported as factors?
...
#QUESTION -- this clearly is not right -- is this a class thing?
...
#QUESTION -- error here re: geometry
...
#QUESTION -- this is only one record?
