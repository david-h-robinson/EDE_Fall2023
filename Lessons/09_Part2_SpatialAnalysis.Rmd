...
mapView(huc8_sf, zcol = "ACRES") #ggplot can also do this
...
mapView(huc8_sf, col.region = 'orange') |
  mapView(neuse_sf, col.region = 'purple') #this makes a neat little slider thing
...
#there is some link updating to do here
